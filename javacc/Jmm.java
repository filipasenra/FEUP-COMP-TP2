...
if (jjtc000) {
  ...
  static final public void Equality() throws ParseException {/*@bgen(jjtree) Equality */
...
if (jjtc001) {
  ...
  static final public void FinalExpression() throws ParseException {Token t;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case NEW:{
      New();
      break;
...
if (jjtc002) {
  ...
  static final public void NewIntObject() throws ParseException {/*@bgen(jjtree) NewIntObject */
...
if (jjtc000) {
  ...
  static final public void NewObject() throws ParseException {/*@bgen(jjtree) NewObject */
