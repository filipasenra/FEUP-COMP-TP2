...
public class Jmm/*@bgen(jjtree)*/implements JmmTreeConstants, JmmConstants {/*@bgen(jjtree)*/
  protected JJTJmmState jjtree = new JJTJmmState();
    ...
    private void errorHandling(ParseException e, int kind) {
        ...
        System.out.println("Syntatic error: " + e.getLocalizedMessage());  // print the error message
    ...
    private void error_skipto(int kind) {
            ...
            System.out.println("Missing ) on while expression.");
        }
        else {
...
if (jjtc002) {
  ...
  final public void NewIntObject() throws ParseException {/*@bgen(jjtree) NewIntObject */
